                    ...
                    <div class="lg:w-1/2 p-8 md:p-12 flex flex-col justify-center">
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="flex items-start gap-4 ${colorClass.bgLight} rounded-2xl p-4">
                                <div class="flex-shrink-0 w-10 h-10 ${colorClass.bg} rounded-xl flex items-center justify-center text-white">
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div class="flex items-center gap-3 bg-gray-50 rounded-xl p-4">
                                    <div class="w-10 h-10 bg-gray-200 rounded-xl flex items-center justify-center text-gray-600">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                    ...
                                    <div>
                                        ...
                                        <a href="tel:${location.phone.replace(/\s/g, '')}" class="text-gray-800 font-bold hover:${colorClass.text}">${location.phone}</a>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-center gap-3 bg-gray-50 rounded-xl p-4">
                                    ...
                                    <div>
                                        ...
                                        <a href="mailto:${location.email}" class="text-gray-800 font-bold hover:${colorClass.text} text-sm">${location.email}</a>
                                    </div>
                                </div>
                            </div>
                        </div>
